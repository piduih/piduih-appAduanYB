...
export const InProgressIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 inline-block animate-spin" viewBox="0 0 20 20" fill="currentColor" style={{ animationDuration: '3s' }}>
